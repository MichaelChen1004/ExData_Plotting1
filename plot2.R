...
# Learning Repo, make serveral plots to png files, this is the plot #2:
...
plot2 <- function() {
    ...
    # make scatter plot of global active power and date.
    plot(twoDdataset$date, twoDdataset$global.active.power, 
